...
#cross validation and model selection for elastic net
params = {
        "alpha": [0.0001,0.01,0.1,1],
        "l1_ratio": [0.1,0.2,0.5,0.9,1],
        "max_iter": [200, 1000,3000]
    }
eNet = ElasticNet()
model_enet = GridSearchCV(eNet, params, cv=3, verbose = 20)

#fit the model
model_enet.fit(X_train_scaled, Y_train_scaled)

#extract better performing parameters
model_enet.best_params_
model_enet.best_score_
